...
print(f"El area de un {rectangulo.get_identificador()} de base {base} y altura {altura} es: {rectangulo.get_area(base, altura)} y el perñimetro es:{rectangulo.get_perimetro(base, altura)}")

radio = 2
print(f"El area del circulo de radio {radio} es: {circunferencia.get_area(2)}")